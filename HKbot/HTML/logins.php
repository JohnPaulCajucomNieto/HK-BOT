...
<head>
    ...
    <title>Login</title>
    <link rel="shortcut icon" href="/HTML/about_hk-removebg-preview.png" type="image/x-icon">
    <link rel="shortcut icon" href="../images/araullo-university-logo-removebg-preview.png" type="image/x-icon">
</head>
    <style>
body {
    background-image:
    linear-gradient(45deg, rgba(0, 0, 0, 0.678), rgba(0, 0, 0, 0.678)), 
    url('au.jpg');
...
document.addEventListener('DOMContentLoaded', function() {
            ...
            var signInButton = document.querySelector('.button-submit');
